...
mkThumbnail($des,54,54,"../upload/product/sm/".$filename);
mkThumbnail($des,450,450,"../upload/product/md/".$filename);
mkThumbnail($des,800,800,"../upload/product/lg/".$filename);
...
//   3.1:获取商品编号
 ...
 //3.4:如果没有添加
 $sql = " INSERT INTO xz_laptop_pic VALUES(null,";
 $sql .= " $lid,'$sm','$md','$lg')";
 //3.5:如果有更新
